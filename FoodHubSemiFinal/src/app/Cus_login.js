...
export class Cus_login extends React.Component {
   constructor(props){
       super(props);
       this.state={
           email:'',
  ...
  { 
   ...
   // inputEmail4.style.border="1px solid red";
    ...
    fetch('http://localhost:3000/reg/signup',{
      method:"POST",
      headers: {
...
this.setState({
   ...
   // inputEmail4.style.border="1px solid red";
    ...
    e.preventDefault();
    fetch("http://localhost:3000/reg/cus_verifyemail",{
     method:"POST",
     headers: {
       "Content-Type": "application/json"
     },
    ...
    render(){
        ...
        return(
          <div class="fluid"  style={{backgroundImage: "url(" + mywall + ")" , backgroundSize:"100%" , backgroundRepeat:"no-repeat",backgroundPosition:"fixed"}}>
            ...
            <h1 style={{color:"#031730"}}>~~~~~~~Im a Customer~~~~~~</h1>
          ...
          <div class="col-md-2">
                ...
                <div class="col-md-4">
                       ...
                       <a href="/cus_forgetpw">Can't remember Password..?</a>
                        </div>
                        </div>
                         <div class="row">
                        <div class="col-xs-2">
      ...
      <div class="modal-footer">
       ...
       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit"  onClick={this.firstclickshow.bind(this)}  class="btn btn-primary">Sign Up</button>
              ...
              <div class="col-md-6">
              <br/>
              <h1 style={{color:"#EEECEC", fontFamily:"bold" ,textShadow:" -1px 0 black, 0 5px black, 1px 0 black, 0 -1px black"}}>Log in first to get the <br/><br/> experience of Food Hub<br/><br/>as a Customer</h1>
           </div>
...
export default withRouter(Cus_login)